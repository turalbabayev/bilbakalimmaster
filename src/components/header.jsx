...
import { FaBell, FaUsers, FaExclamationTriangle, FaChartBar, FaFilePdf, FaVideo, FaMobileAlt, FaComments, FaPodcast, FaQuestionCircle, FaGamepad, FaHome, FaStickyNote, FaGraduationCap, FaBullhorn, FaSignOutAlt, FaChevronRight, FaChevronLeft, FaBook, FaBars, FaTimes, FaCreditCard, FaBox, FaCog, FaWpforms } from 'react-icons/fa';
    ...
    const menuCategories = [
        ...
        },
        {
            ...
            items: [
                ...
                { path: "/form-ayarlari", label: "Ön Katılım Talepleri", icon: <FaWpforms /> },
